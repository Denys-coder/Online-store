...
//        itemInDb.setPictureNames(List.of("old image1", "old image2"));
//        List<String> oldImages = new ArrayList<>();
//        oldImages.add(itemInDb.getLogoName());
//        oldImages.addAll(itemInDb.getPictureNames());
...
//            itemInDb.setPictureNames(List.of("new image1", "new image2"));
//            return null;
